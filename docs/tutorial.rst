...
.. _`Edit this file`: https://github.com/mqlab-dev/pycookiecutter/blob/master/docs/tutorial.rst
...
See :doc:`travis_pypi_setup` for more information.
...
Visit our :doc:`troubleshooting` page for help. If that doesn't help, go to our `Issues`_ page and create a new Issue. Be sure to give as much information as possible.

.. _`Issues`: https://github.com/mqlab-dev/pycookiecutter/issues
